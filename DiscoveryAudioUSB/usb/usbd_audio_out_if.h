...
#include "usbd_audio_core.h"			//needed for USBD_AUDIO_FREQ
...
#define	AUDIO_TOTAL_IF_NUM				0x04				//0x04, cover EP 3 !
#define	AUDIO_OUT_EP					0x03				//0x03, 0x8X is IN (device->host) and others are OUT (host->device), has to be EP 3
#define	DEFAULT_VOLUME					0x7F				//0x7F is maximum on DAC

/* defined in usbd_audio_core.h
